...
/**
 * 
 * Oracle JDBC Wrapped ResultSet/OracleResultSet implementation
 * @author <a href="mailto:averemee@a2.solutions">Aleksei Veremeev</a>
 * 
 */
public class OraWrappedResultSet extends OraForwardWrapper implements OracleResultSet {

	final Statement statement;
	final OracleResultSet oracle;

	OraWrappedResultSet(Statement statement, ResultSet resultSet) {
		super(resultSet);
		this.statement = statement;
		this.oracle = (OracleResultSet) resultSet;
	}
